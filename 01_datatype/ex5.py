...
# print(s.index("Java"))            # 인덱스 반환 ( 없으면 ), ValueError

# 부분 문자열이 몇 번 나오는지 알려주는 문자열 메소드
print(s.count("o"))  # 등장 횟수, 3
...
# 문제) replace는 원본 문자열을 바꿀까요? 새로운 문자열을 만들까요? 새로운 문자열 만듬
...
print(
    "123".isdigit()
)  # 숫자이면 True (숫자 말고 다른 거 들어있으면 안 됨(공백도 안 됨))
print("123".isnumeric())  # 숫자이면 True (한자, 로마자 등까지 허용)
